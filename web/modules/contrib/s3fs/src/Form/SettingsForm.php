...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $additional_folders['public_folder'] = [
      ...
      '#default_value' => !empty($config->get('public_folder')) ? $config->get('public_folder') : 's3fs-public',
      '#description'   => $this->t(
    ...
    $additional_folders['private_folder'] = [
      ...
      '#default_value' => !empty($config->get('private_folder')) ? $config->get('private_folder') : 's3fs-private',
      '#description'   => $this->t(
